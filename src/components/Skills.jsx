...
const row1 = [
  { name: 'HTML', color: '#E34F26', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M4 3l1.5 17L12 22l6.5-2L20 3H4z" fill="currentColor" opacity="0.15" /><path d="M4 3l1.5 17L12 22l6.5-2L20 3H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M16 8H8l.5 4.5H15.5L15 16.5 12 17.5 9 16.5l-.2-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
  { name: 'CSS', color: '#1572B6', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M4 3l1.5 17L12 22l6.5-2L20 3H4z" fill="currentColor" opacity="0.15" /><path d="M4 3l1.5 17L12 22l6.5-2L20 3H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M16 8H8l.3 3h7.4L15 15l-3 1-3-1-.2-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
  { name: 'Tailwind', color: '#06B6D4', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M12 6C9.6 6 8.1 7.2 7.5 9.6c.9-1.2 1.95-1.65 3.15-1.35.685.171 1.174.668 1.716 1.219C13.23 10.8 14.18 11.82 16.5 11.82c2.4 0 3.9-1.2 4.5-3.6-.9 1.2-1.95 1.65-3.15 1.35-.685-.171-1.174-.668-1.716-1.219C15.27 7.02 14.32 6 12 6zM7.5 11.82C5.1 11.82 3.6 13.02 3 15.42c.9-1.2 1.95-1.65 3.15-1.35.685.171 1.174.668 1.716 1.219C8.73 16.62 9.68 17.64 12 17.64c2.4 0 3.9-1.2 4.5-3.6-.9 1.2-1.95 1.65-3.15 1.35-.685-.171-1.174-.668-1.716-1.219C10.77 12.84 9.82 11.82 7.5 11.82z" fill="currentColor" /></svg>) },
  { name: 'JavaScript', color: '#E5A93C', icon: (<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="2" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth="1.5" /><path d="M8 17c.5.7 1.2 1 2.1 1 1.3 0 2.1-.7 2.1-2.1V12H10v3.8c0 .6-.2.9-.8.9-.4 0-.7-.2-1-.5L8 17z" fill="currentColor" /><path d="M14 16.8c.6.7 1.4 1.2 2.5 1.2 1.3 0 2.3-.7 2.3-1.9 0-1.1-.6-1.6-1.7-2.1l-.5-.2c-.5-.2-.8-.4-.8-.8 0-.3.3-.6.7-.6.4 0 .7.2 1 .5l1-1c-.6-.7-1.3-1-2.1-1-1.2 0-2.1.7-2.1 1.8 0 1.1.6 1.6 1.6 2.1l.5.2c.6.3.9.5.9.9 0 .4-.3.7-.9.7-.5 0-1-.3-1.3-.7L14 16.8z" fill="currentColor" /></svg>) },
];

const row2 = [
  { name: 'React', color: '#00D8FF', icon: (<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="2" fill="currentColor" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" transform="rotate(60 12 12)" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" transform="rotate(120 12 12)" /></svg>) },
  { name: 'GSAP', color: '#0ae448', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M12 3L3 8.5V15.5L12 21L21 15.5V8.5L12 3Z" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M8 12h8M12 8v8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>) },
  { name: 'PHP', color: '#777BB4', icon: (<svg viewBox="0 0 24 24" fill="none"><ellipse cx="12" cy="12" rx="10" ry="6" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth="1.5" /><path d="M7 12l2-2h3c1 0 1.5.5 1.5 1.5S12 13 11 13H9L8.5 15" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
  { name: 'MySQL', color: '#00758F', icon: (<svg viewBox="0 0 24 24" fill="none"><ellipse cx="12" cy="7" rx="8" ry="3" fill="currentColor" opacity="0.2" stroke="currentColor" strokeWidth="1.5" /><path d="M4 7v5c0 1.66 3.58 3 8 3s8-1.34 8-3V7" stroke="currentColor" strokeWidth="1.5" /><path d="M4 12v5c0 1.66 3.58 3 8 3s8-1.34 8-3v-5" stroke="currentColor" strokeWidth="1.5" /></svg>) },
];

const row3 = [
  { name: 'Git', color: '#F05032', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M21.7 11.3l-9-9a1 1 0 00-1.4 0l-2 2 2.4 2.4-4 0-4 4 9 9a1 1 0 001.4 0l9-9a1 1 0 000-1.4z" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><circle cx="9" cy="9" r="1.5" fill="currentColor" /><circle cx="15" cy="9" r="1.5" fill="currentColor" /></svg>) },
  { name: 'GitHub', color: '#24292e', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M12 2C6.48 2 2 6.58 2 12.26c0 4.54 2.87 8.39 6.84 9.75.5.09.68-.22.68-.49v-1.71c-2.78.62-3.37-1.37-3.37-1.37-.45-1.18-1.1-1.5-1.1-1.5-.9-.63.07-.62.07-.62 1 .07 1.52 1.05 1.52 1.05.89 1.56 2.33 1.11 2.9.85.09-.66.35-1.11.63-1.37-2.22-.26-4.55-1.14-4.55-5.06 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.3.1-2.71 0 0 .84-.28 2.75 1.05A9.4 9.4 0 0112 8.13c.85 0 1.7.12 2.5.34 1.9-1.33 2.74-1.05 2.74-1.05.55 1.41.2 2.45.1 2.71.64.72 1.03 1.63 1.03 2.75 0 3.94-2.34 4.8-4.57 5.06.36.32.68.94.68 1.9v2.82c0 .27.18.59.69.49C19.14 20.65 22 16.8 22 12.26 22 6.58 17.52 2 12 2z" fill="currentColor" /></svg>) },
  { name: 'Figma', color: '#F24E1E', icon: (<svg viewBox="0 0 24 24" fill="none"><rect x="8" y="3" width="8" height="5" rx="2" fill="currentColor" opacity="0.3" stroke="currentColor" strokeWidth="1.5" /><rect x="8" y="8" width="4" height="5" rx="2" fill="currentColor" opacity="0.3" stroke="currentColor" strokeWidth="1.5" /><rect x="8" y="13" width="4" height="5" rx="2" fill="currentColor" opacity="0.3" stroke="currentColor" strokeWidth="1.5" /><circle cx="16" cy="10.5" r="2.5" fill="currentColor" opacity="0.5" stroke="currentColor" strokeWidth="1.5" /></svg>) },
  { name: 'Vite', color: '#646CFF', icon: (<svg viewBox="0 0 24 24" fill="none"><path d="M12 2L3 5l2 14 7 3 7-3 2-14-9-3z" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth="1.5" /><path d="M12 2L3 5l2 14 7 3 7-3 2-14L12 2z" stroke="currentColor" strokeWidth="1.5" /><path d="M12 6l-5 6h4l-1 6 7-8h-4l1-4z" fill="currentColor" /></svg>) },
];
...
const SkillSliderRow = ({ items, direction = 'left', speed = 25, className = '' }) => {
  ...
  useGSAP(() => {
    ...
    const tween = gsap.fromTo(el,
      { xPercent: fromVal },
      { xPercent: toVal, duration: speed, ease: 'none', repeat: -1 }
    );
  ...
  return (
    ...
    >
      <div ref={rowInnerRef} className="flex gap-5 md:gap-6 w-max [will-change:transform]">
        {quadrupledItems.map((skill, idx) => {
          const brandRgb = hexToRgb(skill.color);
          return (
            <div
              key={idx}
              style={{ '--brand-color': skill.color, '--brand-rgb': brandRgb }}
...
const Skills = () => {
  ...
  useGSAP(() => {
    ...
    const scrollContainer = section.closest('[data-scroll-portfolio]') || window;
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-dvh overflow-hidden bg-[#F5F5F7] flex flex-col items-center justify-evenly p-6">
