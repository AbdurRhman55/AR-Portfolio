...
const Portfolio = ({ onNavigateToHome, onNavigateToAbout }) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full bg-[#121212] select-none overflow-x-hidden overflow-y-auto"
    >
      <div className="relative w-full h-dvh bg-gradient-to-t from-[#0055FF] via-[#a8b0bd] to-[#121212] flex items-center justify-center overflow-hidden">
        ...
        <Header onHomeClick={onNavigateToHome} onPortfolioClick={() => {}} onAboutClick={onNavigateToAbout} />

        <div className="relative flex flex-col items-center justify-center w-full ">
          <h1 ref={titleRef} className="text-[32vw] md:text-[25vw] font-display text-white/90 leading-none tracking-tighter uppercase select-none">
            PORTFOLIO
          </h1>

          <div ref={videoRef} className="hidden md:flex absolute inset-0 items-center justify-center z-10 pointer-events-none mix-blend-screen md:mix-blend-normal transform translate-z-0">
            <video autoPlay loop muted playsInline className="w-full h-full object-contain max-h-[80vh]">
              <source src="/nb-keychain-01-_DeMain-V9.webm" type="video/webm" />
            </video>
          </div>

          <div ref={descriptionRef} className="flex md:hidden flex-col items-center gap-3 mt-6 absolute top-[100%] z-20 w-full">
            ...
            <p className="text-white/70 text-[9px] md:text-xs tracking-[0.2em] uppercase font-light text-center max-w-[320px] md:max-w-[450px] leading-relaxed">
